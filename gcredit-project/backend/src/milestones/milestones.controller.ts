...
export class MilestonesController {
  ...
  @ApiResponse({ status: 201, description: 'Milestone config created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Milestone configs retrieved successfully' })
  @ApiResponse({ status: 403, description: 'Insufficient permissions' })
  ...
  @ApiResponse({ status: 200, description: 'Milestone config updated successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Milestone config deleted (soft delete)' })
  @ApiResponse({ status: 404, description: 'Milestone config not found' })
  @ApiResponse({ status: 403, description: 'Insufficient permissions' })
